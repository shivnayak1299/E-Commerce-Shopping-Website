                        ...
                        <table class="table table-bordered" border="1">
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    ?>
                                    <br />
                                    <a href="javascript:void(0);" onClick="popUpWindow('track-order.php?oid=<?php echo $row['orderid'];?>');" title="Track order"> Track order</a>
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div class="col-6">
                        <table class="table table-bordered" border="1">
                            <tr>
                                ...
                                <td>
                                    <address>
                                        <?php echo htmlentities($row['billingAddress']);?><br />
                            ...
                            <tr>
                                ...
                                <td>
                                    <address>
                                        <?php echo htmlentities($row['shippingAddress']);?><br />
                            ...
                            <tr>
                                <td colspan="2">
                                    <a href="javascript:void(0);" onClick="popUpWindow('cancelorder.php?oid=<?php echo $row['orderid'];?>');" title="Cancel Order" class="btn-upper btn btn-danger">Cancel this Order</a>
                                </td>
                            </tr>
                        </table>
                    </div>
                ...
                <table class="table">
                    ...
                    <tbody>
                        ...
                        if($num > 0) {
                            ...
                            ?>
                            <tr>
                                <td style="font-size: 18px; font-weight:bold; color:red;">Invalid Request</td>
                            </tr>
                            <?php
                        }
                        ?>
